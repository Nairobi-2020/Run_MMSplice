...
####################################################################################################################
# Set paramenters.
raw.dir = 'Lock/WGS/Kipoi/MMSplice/Raw/PCAWG/'
anno.dir = 'Lock/WGS/Kipoi/MMSplice/Annotated/PCAWG/'
...
for (mmsplice.file in mmsplice.files)    {
  ...
  write.table(aster, paste0(anno.dir, mmsplice.file), row.names=FALSE, col.names=TRUE, quote=FALSE, sep='\t')
  }
